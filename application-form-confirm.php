...
if(!($_SERVER['HTTP_REFERER'] == 'http://localhost/10.12.1.2/application-form')) header("Location: http://10.12.1.2:8080/");//前のページが申請フォームか
...
?>
  <div class="container">
    <div id="main" class="col-md-10">
      ...
      <h4 style="padding-bottom: 40px">以下の内容で間違いがないか確認してください。<br>間違いがある場合は<a href="./application-form">元のページに戻り</a>訂正を行ってください。</h4>
      ...
      <form id="application" class="form-horizontal" role="form" action="application-form-complete" method="post">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input type="text" class="form-control" name="room" id="room" value="<?php if($_SESSION['gender'] == 'male') echo '男子'; elseif($_SESSION['gender'] == 'female') echo '女子' ?>" disabled>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input type="text" class="form-control" name="room" id="room" value="<?php echo $_SESSION['room'] ?>" disabled>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input type="text" class="form-control" name="student-id" id="student-id" value="<?php echo $_SESSION['student_id'] ?>" disabled>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-7">
            <div class="row">
              <div class="col-md-6">
                <input type="text" class="form-control" name="last-name-roma" value="<?php echo $_SESSION['last_roma_name'] ?>" disabled>
              </div>
              <div class="col-md-6">
                <input type="text" class="form-control" name="first-name-roma" value="<?php echo $_SESSION['first_roma_name'] ?>" disabled>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-7">
            <div class="row">
              <div class="col-md-6">
                <input type="text" class="form-control" name="last-name" value="<?php echo $_SESSION['last_name'] ?>" disabled>
              </div>
              <div class="col-md-6">
                <input type="text" class="form-control" name="first-name" value="<?php echo $_SESSION['first_name'] ?>" disabled>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input type="text" class="form-control" name="mac-address" id="mac-address" value="<?php echo $_SESSION['mac_address'] ?>" disabled>
          </div>
        </div>
